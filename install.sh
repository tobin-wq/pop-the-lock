...
GAME_URL="$REPO_RAW/pop-the-lock.py"
...
# Save the cursor position right after the install banner. After the game
# exits we restore it and wipe everything the curses display left behind so
# the prompt comes back cleanly.
printf '\033[s'
